package com.sensis.demo.one.util;
...
public class PasswordUtil {
	...
	public static boolean comparePassword(String attemptedPassword, byte[] encryptedPassword, byte[] salt) throws NoSuchAlgorithmException, InvalidKeySpecException {
